    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      <div class="pt-32 pb-12 md:pt-40 md:pb-20">
        ...
        <div class="max-w-3xl pb-12 md:pb-20 text-center md:text-left">
          <h1 class="h1" data-aos="fade-up">Refreshing news for developers and designers</h1>
        </div>
          ...
          <article class="max-w-sm mx-auto md:max-w-none grid md:grid-cols-2 gap-6 md:gap-8 lg:gap-12 xl:gap-16 items-center">
            <router-link to="/blog-post" class="relative block group" data-aos="fade-right" data-aos-delay="200">
              ...
              <figure class="relative h-0 pb-9/16 md:pb-3/4 lg:pb-9/16 overflow-hidden transform md:-translate-y-2 xl:-translate-y-4 group-hover:translate-x-0 group-hover:translate-y-0 transition duration-700 ease-out">
                <img class="absolute inset-0 w-full h-full object-cover transform hover:scale-105 transition duration-700 ease-out" src="../images/blog-post-01.jpg" width="540" height="303" alt="Blog post 01">
              </figure>
            </router-link>
            <div data-aos="fade-left" data-aos-delay="200">
              <header>
                ...
                <h3 class="h3 text-2xl lg:text-3xl mb-2">
                  <router-link to="/blog-post" class="hover:text-gray-100 transition duration-150 ease-in-out">Designing a functional workflow at home.</router-link>
                </h3>
              </header>
              <p class="text-lg text-gray-400 grow">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat.</p>
              <footer class="flex items-center mt-4">
                <a href="#0">
                  <img class="rounded-full shrink-0 mr-4" src="../images/news-author-04.jpg" width="40" height="40" alt="Author 04">
                </a>
                <div>
        ...
        <div class="max-w-sm mx-auto md:max-w-none">
          ...
          <!-- Section title -->
          <h4 class="h4 pb-6 mb-10 border-b border-gray-700" data-aos="fade-up">Latest articles</h4>
          ...
          <div class="grid gap-12 md:grid-cols-3 md:gap-x-6 md:gap-y-8 items-start">
            ...
            <article class="flex flex-col h-full" data-aos="fade-up" data-aos-delay="100">
              <header>
                <router-link to="/blog-post" class="block mb-6">
                  <figure class="relative h-0 pb-9/16 overflow-hidden rounded-sm">
                    <img class="absolute inset-0 w-full h-full object-cover transform hover:scale-105 transition duration-700 ease-out" src="../images/news-02.jpg" width="352" height="198" alt="News 02">
                  </figure>
                </router-link>
                <div class="mb-3">
                  <ul class="flex flex-wrap text-xs font-medium -m-1">
            ...
            <article class="flex flex-col h-full" data-aos="fade-up" data-aos-delay="200">
              <header>
                <router-link to="/blog-post" class="block mb-6">
                  <figure class="relative h-0 pb-9/16 overflow-hidden rounded-sm">
                    <img class="absolute inset-0 w-full h-full object-cover transform hover:scale-105 transition duration-700 ease-out" src="../images/news-03.jpg" width="352" height="198" alt="News 03">
                  </figure>
                </router-link>
                <div class="mb-3">
                  <ul class="flex flex-wrap text-xs font-medium -m-1">
            ...
            <article class="flex flex-col h-full" data-aos="fade-up">
              <header>
                <router-link to="/blog-post" class="block mb-6">
                  <figure class="relative h-0 pb-9/16 overflow-hidden rounded-sm">
                    <img class="absolute inset-0 w-full h-full object-cover transform hover:scale-105 transition duration-700 ease-out" src="../images/news-04.jpg" width="352" height="198" alt="News 04">
                  </figure>
                </router-link>
                <div class="mb-3">
                  <ul class="flex flex-wrap text-xs font-medium -m-1">
              ...
              <footer class="flex items-center mt-4">
                <a href="#0">
                  <img class="rounded-full shrink-0 mr-4" src="../images/news-author-05.jpg" width="40" height="40" alt="Author 05">
                </a>
                <div class="font-medium">
                  <a class="text-gray-200 hover:text-gray-100 transition duration-150 ease-in-out" href="#0">Alexandra Smith</a>
                  <span class="text-gray-700"> - </span>
            ...
            <article class="flex flex-col h-full" data-aos="fade-up" data-aos-delay="100">
              <header>
                <router-link to="/blog-post" class="block mb-6">
                  <figure class="relative h-0 pb-9/16 overflow-hidden rounded-sm">
                    <img class="absolute inset-0 w-full h-full object-cover transform hover:scale-105 transition duration-700 ease-out" src="../images/news-05.jpg" width="352" height="198" alt="News 05">
                  </figure>
                </router-link>
                <div class="mb-3">
                  <ul class="flex flex-wrap text-xs font-medium -m-1">
            ...
            <article class="flex flex-col h-full" data-aos="fade-up" data-aos-delay="200">
              <header>
                <router-link to="/blog-post" class="block mb-6">
                  <figure class="relative h-0 pb-9/16 overflow-hidden rounded-sm">
                    <img class="absolute inset-0 w-full h-full object-cover transform hover:scale-105 transition duration-700 ease-out" src="../images/news-06.jpg" width="352" height="198" alt="News 06">
                  </figure>
                </router-link>
                <div class="mb-3">
                  <ul class="flex flex-wrap text-xs font-medium -m-1">
              ...
              <footer class="flex items-center mt-4">
                <a href="#0">
                  <img class="rounded-full shrink-0 mr-4" src="../images/news-author-06.jpg" width="40" height="40" alt="Author 06">
                </a>
                <div class="font-medium">
                  <a class="text-gray-200 hover:text-gray-100 transition duration-150 ease-in-out" href="#0">Anton Sebastian</a>
                  <span class="text-gray-700"> - </span>
            ...
            <article class="flex flex-col h-full" data-aos="fade-up">
              <header>
                <router-link to="/blog-post" class="block mb-6">
                  <figure class="relative h-0 pb-9/16 overflow-hidden rounded-sm">
                    <img class="absolute inset-0 w-full h-full object-cover transform hover:scale-105 transition duration-700 ease-out" src="../images/news-07.jpg" width="352" height="198" alt="News 07">
                  </figure>
                </router-link>
                <div class="mb-3">
                  <ul class="flex flex-wrap text-xs font-medium -m-1">
            ...
            <article class="flex flex-col h-full" data-aos="fade-up" data-aos-delay="100">
              <header>
                <router-link to="/blog-post" class="block mb-6">
                  <figure class="relative h-0 pb-9/16 overflow-hidden rounded-sm">
                    <img class="absolute inset-0 w-full h-full object-cover transform hover:scale-105 transition duration-700 ease-out" src="../images/news-08.jpg" width="352" height="198" alt="News 08">
                  </figure>
                </router-link>
                <div class="mb-3">
                  <ul class="flex flex-wrap text-xs font-medium -m-1">
            ...
            <article class="flex flex-col h-full" data-aos="fade-up" data-aos-delay="200">
              <header>
                <router-link to="/blog-post" class="block mb-6">
                  <figure class="relative h-0 pb-9/16 overflow-hidden rounded-sm">
                    <img class="absolute inset-0 w-full h-full object-cover transform hover:scale-105 transition duration-700 ease-out" src="../images/news-09.jpg" width="352" height="198" alt="News 09">
                  </figure>
                </router-link>
                <div class="mb-3">
                  <ul class="flex flex-wrap text-xs font-medium -m-1">
        ...
        <nav class="flex justify-center pt-16" role="navigation" aria-label="Pagination Navigation">
          <ul class="inline-flex flex-wrap font-medium text-sm -m-1">
            <li class="m-1">
              <span class="inline-flex h-10 min-w-10 justify-center items-center bg-gray-800 px-4 rounded-full text-gray-500">Prev</span>
            </li>
            <li class="m-1">
              <a href="#0" class="inline-flex h-10 min-w-10 justify-center items-center bg-gray-800 px-2 rounded-full text-gray-300 hover:bg-purple-600 transition-colors duration-150 ease-in-out">1</a>
            </li>
            <li class="m-1">
              <a href="#0" class="inline-flex h-10 min-w-10 justify-center items-center bg-gray-800 px-2 rounded-full text-gray-300 hover:bg-purple-600 transition-colors duration-150 ease-in-out">2</a>
            </li>
            <li class="m-1">
              <a href="#0" class="inline-flex h-10 min-w-10 justify-center items-center bg-gray-800 px-2 rounded-full text-gray-300 hover:bg-purple-600 transition-colors duration-150 ease-in-out">3</a>
            </li>
            <li class="m-1">
              <span class="inline-flex h-10 min-w-10 justify-center items-center bg-gray-800 px-2 rounded-full text-gray-500">...</span>
            </li>
            <li class="m-1">
              <a href="#0" class="inline-flex h-10 min-w-10 justify-center items-center bg-gray-800 px-2 rounded-full text-gray-300 hover:bg-purple-600 transition-colors duration-150 ease-in-out">12</a>
            </li>
            <li class="m-1">
              <a href="#0" class="inline-flex h-10 min-w-10 justify-center items-center bg-gray-800 px-4 rounded-full text-gray-300 hover:bg-purple-600 transition-colors duration-150 ease-in-out">Next</a>
            </li>
          </ul>
        </nav>
