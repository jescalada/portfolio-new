    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      <div class="py-12 md:py-20 border-t border-gray-800">
        ...
        <div class="max-w-3xl mx-auto pb-16">
          <ul
            class="flex flex-col sm:flex-row flex-wrap justify-center items-center text-lg text-gray-400 -mx-3 -my-2"
          >
            <li
        ...
        <div class="max-w-2xl mx-auto">
          ...
          <div class="py-12">
            <div class="relative">
              <!-- Map -->
              <div
                class="absolute inset-0 flex justify-center items-end"
                aria-hidden="true"
              >
                <div
                  class="bottom-0 border-l border-dashed border-gray-500 transform translate-y-8"
                  style="height: 50%"
                ></div>
              </div>
              <!-- People pics -->
              ...
              <template :key="index" v-for="(item, index) in items">
                <div v-show="active === index" class="text-center">
                  ...
                  >
                    ...
                    />
                    <svg
                      class="absolute top-0 right-0 -mr-3 w-6 h-5 fill-current text-purple-600"
                      viewBox="0 0 24 20"
                      xmlns="http://www.w3.org/2000/svg"
                    >
                      <path
